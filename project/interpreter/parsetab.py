...
_lr_productions = [
  ...
  ('quote -> assign','quote',1,'p_quote_assign','parser.py',11),
  ('quote -> expr','quote',1,'p_quote_expr','parser.py',15),
  ('assign -> ID EQUALS expr','assign',3,'p_assign','parser.py',19),
  ('expr -> expr PLUS term','expr',3,'p_expr_sum','parser.py',24),
  ('expr -> expr MINUS term','expr',3,'p_expr_min','parser.py',31),
  ('expr -> expr DIVIDE term','expr',3,'p_expr_div','parser.py',38),
  ('expr -> expr TIMES term','expr',3,'p_expr_time','parser.py',45),
  ('expr -> term','expr',1,'p_expr_term','parser.py',52),
  ('term -> NUMBER','term',1,'p_term_num','parser.py',56),
  ('term -> SHOW','term',1,'p_command','parser.py',60),
  ('term -> ID','term',1,'p_term_id','parser.py',64),
  ('term -> TEXT','term',1,'p_term_text','parser.py',68),
]
